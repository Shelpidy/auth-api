...
export const tenants = pgTable("tenants", {
  ...
  government_alternate_registration_id: text("government_alternate_registration_id"),
  ...
  education_highest_grade_level: text("education_highest_grade_level").notNull(),
...
export const tenant_contacts = pgTable("tenant_contacts", {
  ...
  tenant_nano_id: text("tenant_nano_id").references(() => tenants.tenant_nano_id, {
    onDelete: "cascade",
    onUpdate: "cascade",
  }),
...
export const tenant_subscriptions = pgTable("tenant_subscriptions", {
  tenant_subscription_nano_id: varchar("tenant_subscription_nano_id", { length: 22 }).primaryKey(),
  tenant_subscription_id: serial("tenant_subscription_id").notNull(),
  tenant_nano_id: varchar("tenant_nano_id", { length: 22 }).references(() => tenants.tenant_nano_id, {
    onDelete: "cascade",
    onUpdate: "cascade",
  }),
  subscription_name: text("subscription_name").notNull(),
...
export const user_settings = pgTable("user_settings", {
  user_setting_nano_id: varchar("user_setting_nano_id", { length: 22 }).primaryKey(),
...
export const user_payments = pgTable("user_payments", {
  ...
  user_payment_nano_id: varchar("user_payment_nano_id", { length: 22 }).primaryKey(),
  user_nano_id: varchar("user_nano_id", { length: 22 }).references(() => users.user_nano_id),
...
export const tenantLocationsRelations = relations(tenant_locations, ({ one }) => ({
  tenant: one(tenants, {
...
export const tenantContactsRelations = relations(tenant_contacts, ({ one }) => ({
  tenant: one(tenants, {
...
export const tenantSettingsRelations = relations(tenant_settings, ({ one }) => ({
  tenant: one(tenants, {
...
export const tenantSubscriptionsRelations = relations(tenant_subscriptions, ({ one }) => ({
  tenant: one(tenants, {
