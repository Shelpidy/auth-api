...
export class RolesService {
  ...
  async create(createRoleDto: CreateRoleDto, currentUser: ICurrentUser) {
    ...
    if (createRoleDto.name.includes('super-admin') && !currentUser.roles.includes("super-admin") || currentUser.tenant_id) {
      throw new ConflictException('Role name is not allowed');
    }
  ...
  async updateRole(role_id: string, updateRoleDto: UpdateRoleDto, currentUser: ICurrentUser) {
    const existingRole = await this.findOne(role_id);
  ...
  async update(id: string, updateRoleDto: UpdateRoleDto, currentUser: ICurrentUser) {
